...
let secondsTarget = 0;  // Change the target seconds as needed
...
document.getElementById('resetButton').addEventListener('click', () => {
  clearInterval(countdownInterval);
  minutesTarget = 1;  // Reset to the initial target minutes
  hoursTarget = 1;    // Reset to the initial target hours
